/*
 *  Bootstrap Front-End boilerplate
...
import htmlCompile from "./gulpfile/tasks/buildhtml";
...
htmlCompile.description = "Copy the Font Fils to distribution";

exports.copyBitmapsTask = copyBitmapsTask;
copyBitmapsTask.description =
    "Move all Bitmap Images (from bitmapSingle-assets) to the .dist Folder";
...
copyVectorsTask.description =
    "Move all SVG Images (from vectorSingle-assets) to the .dist Folder";

exports.copyJsTask = copyJsTask;
copyJsTask.description =
    'Copy Bower Files to "dist/". Use the JSON Array in the config.json [files:jsCopy]]';

exports.buildBitmapSpriteTask = buildBitmapSpriteTask;
buildBitmapSpriteTask.description =
    "Build the Bitmap Sprite File and the SCSS Map";
...
buildVectorSpriteTask.description =
    "Move all SVG Images (from vectorSingle-assets) to the .dist Folder";

exports.buildSymbolCleanupTask = buildSymbolCleanupTask;
buildSymbolCleanupTask.description =
    "Build an SVG Vector Sprite and a Map file";

exports.rebuildImagesTask = rebuildImagesTask;
rebuildImagesTask.description =
    "Rebuild all Images. Copy to distribution, build Sprites";
...
compilerCssTask.description =
    "Watch the working dirs - activates the compilers and refresh the browser";

exports.compilerHtmlTask = compilerHtmlTask;
compilerHtmlTask.description =
    "Compile Twig Files to HTML or copy Structure Files";

exports.criticalCss = criticalCss;
criticalCss.description =
    "Generate Inline CSS for the Above the fold optimization";
...
minifyContentimagesTask.description =
    "Compress all Content Images in distribution";

exports.minifyInlineimagesTask = minifyInlineimagesTask;
minifyInlineimagesTask.description =
    "Compress all Inline Images in distribution";
...
watchTask.description =
    "The Watch Tasks for SASS, PUG or Twig, JS and activate BrowserSync";

...
import buildArchive from './gulpfile/tasks/build-archive'
import projectBump from './gulpfile/tasks/version-bump'
import uploadArchive from './gulpfile/tasks/upload-archive'
...
exports.buildArchive = buildArchive
buildArchive.description = 'Build archive'

exports.projectBump = projectBump
projectBump.description = 'Change project version'

exports.uploadArchive = uploadArchive
uploadArchive.description = 'Upload archive'
